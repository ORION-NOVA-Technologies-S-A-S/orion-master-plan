...
|-----------|-------------|
| Código | ONT-BUS-000 |
| Nombre | Resumen del Modelo de Negocio |
| Versión | 1.0.0 |
...
Cada producto será desarrollado de forma modular e interoperable.
...
- Consolidar un ecosistema interoperable.
...
Su enfoque en la innovación, el desarrollo tecnológico y la generación de valor permitirá consolidar un ecosistema de productos y servicios capaz de responder a los desafíos de la transformación digital y contribuir al desarrollo tecnológico del país y de la región.
